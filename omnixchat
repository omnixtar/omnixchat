...
# java -Xmx256m -cp ../BiglyBT/uis/target/BiglyBT.jar:./commons-cli.jar:swt/J17/swt-x86_64.jar -Djava.library.path=/home/hongwu/devel/2024/github/biglybt -Dazureus.install.path=/home/hongwu/devel/2024/github/biglybt -Dazureus.script=./biglybt-dbg -Dazureus.script.version=11 --add-opens java.base/java.net=ALL-UNNAMED com.biglybt.ui.Main

java -Xmx256m -cp ../../omnixtar/omnixchat/uis/target/BiglyBT.jar:./commons-cli.jar:swt/J17/swt-x86_64.jar -Djava.library.path=/home/hongwu/devel/2024/github/biglybt -Dazureus.install.path=/home/hongwu/devel/2024/github/biglybt -Dazureus.script=./biglybt-dbg -Dazureus.script.version=11 --add-opens java.base/java.net=ALL-UNNAMED com.biglybt.ui.Main


echo $JAVABIN -Xmx256m \
	-cp "${CLASSPATH}" \
	"-Djava.library.path=${PROGRAM_DIR}" \
	"-Dazureus.install.path=${PROGRAM_DIR}" \
	"-Dazureus.script=$0" \
